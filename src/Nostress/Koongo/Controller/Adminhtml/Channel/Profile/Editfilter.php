...
class Editfilter extends SaveAbstract
{
    /**
     * Core registry
     *
    ...
    protected function _initAction()
    {
        ...
        $resultPage->addBreadcrumb(__('Manage Filter Settings'), __('Manage Filter Settings'));
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(__('Edit Channel Profile Filter'), __('Edit Channel Profile Filter'));
        $title = __("Edit Filter - Profile #%1", $model->getId());

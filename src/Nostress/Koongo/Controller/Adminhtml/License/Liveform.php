...
class Liveform extends \Nostress\Koongo\Controller\Adminhtml\License
{
    /**
     * Core registry
     *
    ...
    public function execute()
    {
        ...
        $resultPage->addBreadcrumb(__('Live Activation'), __('Live Activation'));
        $resultPage->getConfig()->getTitle()->prepend(__("Koongo Connector - Activate Live"));

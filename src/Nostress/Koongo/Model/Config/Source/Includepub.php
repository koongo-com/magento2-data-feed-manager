...
class Includepub extends \Nostress\Koongo\Model\Config\Source
{
    ...
    {
        return [
            ['value'=> self::ACCORDING_TO_SYSTEM, 'label'=> __('According to system settings (Recommended)')],
            ['value'=> self::YES, 'label'=> __('Yes - Use PUB in media links.')],
            ['value'=> self::NO, 'label'=> __('No - Never use PUB in media links.')]
        ];
    }
}

...
class Mediagallery extends \Nostress\Koongo\Model\Cache
{
    public function _construct()
    {
        $this->_init('Nostress\Koongo\Model\ResourceModel\Cache\Mediagallery');
    }
    ...
    {
        $this->_getResource()->setImageAttributeSource($source);
    }
}

...
/**
 * Observer for Catalog Inventory Stock Item Save After for Kaas webhooks
 *
 * @category Nostress
...
class InventoryStockItemSaveAfterObserver extends \Nostress\Koongo\Observer\BaseObserver
{
    /**
     * Product factory
     *
    ...
    {
        $cataloginventoryStockItem = $observer->getEvent()->getItem();
        $product = $this->_productFactory->create()->load($cataloginventoryStockItem->getProductId());
